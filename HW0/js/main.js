...
var game = new Phaser.Game(1500, 1000, Phaser.CANVAS, 'game', { preload: preload, create: create, update: update, render: render });
...
function create() {
    ...
    bg = game.add.tileSprite(0, 0, 1500, 1000, 'background');
